...
from sa_networks.resnet_v1 import resnet_v1_152
from sa_networks.resnet_v1 import resnet_arg_scope

class Resnet152ClassifierArch(AbstractCNNArch):
    ...
    def create_model(self, input_x, isTraining, kwargs):
        ...
        with slim.arg_scope(resnet_arg_scope()):
            logits, end_points = resnet_v1_152(input_x, num_classes=self.n_classes, is_training=isTraining)
